  ...
  const tours = [
    {
      ...
      description: `Насыщенная 8-9 часовая экскурсия по главным достопримечательностям региона:

1) Часовня Параскевы Пятницы — главный символ Красноярска с десятирублёвой купюры. Шикарный вид на исторический центр.

2) Николаевская сопка — один из самых высоких флагштоков России. Красноярск с высоты птичьего полёта!

3) Восточный вход Красноярских столбов — Сиенитовый карьер с видом на скальный массив Такмак. Живой источник с целебной водой, возможность перекусить и отправить открытку из визит-центра.

4) Торгашинский хребет — известняковые скалы и виды на Столбинское нагорье. При желании — подъём по самой длинной лестнице России (1683 ступеньки).

5) Смотровая площадка "Царь рыба" — великолепный вид на Енисей и Карауленское нагорье.

6) Овсянка — родина писателя В.П. Астафьева. Национальный центр и набережная с видом на скалы Караульного быка.

7) Дивногорск — город гидростроителей. Остановка у Енисея с видом на скалу "Монах" и трогательная легенда о монахе и его возлюбленной.

8) Набережная Дивногорска — самая красивая набережная Красноярского края. Спуск к Енисею, кормление уток, кафе для обеда.

9) Красноярская ГЭС с нижней смотровой площадки — история строительства станции.

10) ГЭС с верхнего бьефа — мощь плотины, фото с десятирублёвой купюрой, вид на Красноярское море и единственный в России судоподъёмник.

По дороге обратно — возможность заехать в рыбные магазины за енисейской рыбой!

Стоимость: 12 000 ₽ (без подъёма на лестницу) / 14 000 ₽ (с подъёмом) за экскурсию до 3-х человек. Трансфер из гостиницы и обратно включён.`,
      duration: '8-9 часов',
      difficulty: 'Средняя',
      price: '14 000 ₽',
