...
const Index = () => {
  ...
  const tours = [
    {
      id: 1,
      title: 'Столбы: Классический маршрут',
      description: 'Индивидуальная экскурсия по знаменитым скалам заповедника "Столбы"',
      duration: '4-5 часов',
      difficulty: 'Средняя',
      price: 'от 3500 ₽',
      image: 'https://cdn.poehali.dev/projects/bfbb56ee-f92a-4bba-90ab-3a6fd5390bd5/files/fd82efd0-214e-4643-ae8a-e8fc84f7a0d0.jpg'
    },
    {
      id: 2,
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-primary">Краснoyарск Tours</span>
          </div>
